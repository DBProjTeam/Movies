...
insert  into `genre`(`genre`) values ('action'),('comedy'),('drama'),('fantasy'),('fiction'),('horror'),('melodrama'),('science '),('thriller'),('western'),('Драма'),('Приключения'),('Семейный'),('Триллер'),('Ужасы');
...
insert  into `image`(`image_ID`,`name`) values (1,'detal_movie_01.jpg'),(2,'detal_movie_02.jpg'),(3,'detal_movie_03.jpg'),(4,'detal_movie_04.jpg'),(5,'Person_17.jpg'),(6,'Person_07.jpg'),(7,'Person_09.jpg'),(8,'Person_12.jpg'),(9,'detal_movie_main.jpg'),(10,'Person_14.jpg'),(11,'Person_03.jpg'),(12,''),(13,' '),(14,' '),(15,' '),(16,' '),(17,' '),(18,' '),(19,' '),(20,' '),(111,'movie-1.png'),(200,'movie/Post_BelliAndCebactian.jpg'),(201,'movie/Post_BrodDog.jpg'),(202,'movie/Post_GoodSleep.jpg'),(300,'person/Pers_Kristian_Duge.jpg'),(301,'person/Pers_SesilObri.jpg'),(302,'person/Pers_JulLegran.jpg'),(303,'person/Pers_ChekiKario.jpg'),(304,'person/Pers_JonXimKim.jpg'),(305,'person/Pers_SunNumKim.jpg'),(306,'person/Pers_JaumeBakagyjro.jpg'),(307,'person/Pers_AlbertoMarini.jpg'),(308,'person/Pers_XylioFepnandes.jpg');
...
insert  into `movie_image`(`movie_image_ID`,`movie_ID`,`image_ID`) values (1,54,1),(2,54,2),(3,54,3),(4,54,4),(5,200,200),(6,201,201),(7,202,202);
...
insert  into `role`(`role`) values ('\roperator'),('actor'),('actress'),('artist'),('composer'),('DIRECTOR'),('montage'),('operator'),('producer'),('protagonist'),('Roles duplicated'),('scenario'),('Starring');
...
/*!50003 CREATE  PROCEDURE `findMovie`(IN movietitle VARCHAR(30),IN Coun VARCHAR(30),IN Genr VARCHAR(30),IN Stud VARCHAR(30),in from_year  VARCHAR(5), in to_year  VARCHAR(5))
BEGIN
...
/*!50003 CREATE  PROCEDURE `findPerson`(in name varchar(45),in role varchar(45))
BEGIN
	set @name = name;
	set @role = role;
