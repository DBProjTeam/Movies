...
insert  into `user_movie_favorite`(`user_movie_favorite_ID`,`user_ID`,`movie_ID`) values (2,102,54),(4,102,1),(5,102,18);
...
/*!50003 CREATE DEFINER=`pavel`@`%` PROCEDURE `findMovie`(IN movietitle VARCHAR(30),IN c BOOLEAN,IN g BOOLEAN,IN s BOOLEAN,IN Coun VARCHAR(30),IN Genr VARCHAR(30),IN Stud VARCHAR(30),in from_year int, in to_year int)
BEGIN
